          ...
          <div className="bg-[var(--card-bg)] rounded-lg shadow-md border border-[var(--border)] p-6 hover:shadow-lg transition-shadow duration-300">
            <div className="flex justify-between items-start mb-3">
              <div>
                ...
                <p className="text-[var(--text-secondary)] mt-1 font-medium">通信工程 · 本科</p>
              </div>
          ...
          <div className="bg-[var(--card-bg)] rounded-lg shadow-md border-l-4 border-[var(--success)] p-6 hover:shadow-lg transition-shadow duration-300">
            <div className="flex justify-between items-start mb-3">
              <div>
                ...
                <p className="text-[var(--text-secondary)] mt-1 font-medium">模拟IC验证实习生</p>
              </div>
              <span className="text-sm text-[var(--text-muted)] bg-[var(--section-bg)] px-3 py-1 rounded-full">2025.12 - 2026.04</span>
            </div>
            <ul className="text-[var(--text-secondary)] space-y-2 mt-4">
              <li className="flex items-start">
                <span className="text-[var(--success)] mr-2 mt-1.5">◆</span>
                <span>参与电源管理芯片(PMIC)的验证测试工作，负责芯片功能和性能测试</span>
              </li>
              <li className="flex items-start">
                <span className="text-[var(--success)] mr-2 mt-1.5">◆</span>
          ...
          <div className="space-y-3">
            <div className="bg-gradient-to-r from-[var(--section-bg)] to-[var(--card-bg)] rounded-lg p-4 border-l-4 border-[var(--accent)] hover:shadow-md transition-all duration-300 hover:translate-x-1">
              <div className="flex justify-between items-center">
                <div>
                  <h3 className="text-base font-semibold text-[var(--primary)]">全国大学生数学竞赛黑龙江赛区一等奖</h3>
                  <p className="text-sm text-[var(--text-muted)]">2次获得（2023, 2024）</p>
                </div>
            ...
            <div className="bg-gradient-to-r from-[var(--section-bg)] to-[var(--card-bg)] rounded-lg p-4 border-l-4 border-[var(--accent)] hover:shadow-md transition-all duration-300 hover:translate-x-1">
              <div className="flex justify-between items-center">
                <div>
                  <h3 className="text-base font-semibold text-[var(--primary)]">学校学业奖学金</h3>
                  <p className="text-sm text-[var(--text-muted)]">2次获得（2023, 2024）</p>
                </div>
                <span className="text-2xl text-[var(--accent)]">🎓</span>
              </div>
            ...
            <div className="bg-gradient-to-r from-[var(--section-bg)] to-[var(--card-bg)] rounded-lg p-4 border-l-4 border-[var(--accent)] hover:shadow-md transition-all duration-300 hover:translate-x-1">
              <div className="flex justify-between items-center">
                <div>
                  <h3 className="text-base font-semibold text-[var(--primary)]">华大九天杯深圳市电子设计邀请赛三等奖</h3>
                  <p className="text-sm text-[var(--text-muted)]">2025.04</p>
                </div>
                <span className="text-2xl text-[var(--accent)]">🥉</span>
              </div>
            </div>
            <div className="bg-gradient-to-r from-[var(--section-bg)] to-[var(--card-bg)] rounded-lg p-4 border-l-4 border-[var(--accent)] hover:shadow-md transition-all duration-300 hover:translate-x-1">
              <div className="flex justify-between items-center">
                <div>
                  <h3 className="text-base font-semibold text-[var(--primary)]">哈尔滨工业大学优秀学生荣誉</h3>
                  <p className="text-sm text-[var(--text-muted)]">2024.10</p>
                </div>
                <span className="text-2xl text-[var(--accent)]">⭐</span>
              </div>
            </div>
