import { AnimatedSection, HoverCard } from "./components/animations";
    ...
    <div className="max-w-5xl mx-auto px-6 py-12">
      ...
      <section className="mb-16 animate-fade-in-up">
        <div className="flex flex-col md:flex-row gap-8 items-start">
          <div className="flex-1">
            <h1 className="text-4xl font-serif font-bold text-gray-900 mb-4 hover-scale inline-block">
              张昕
            </h1>
            <h2 className="text-xl text-gray-600 mb-6 animate-fade-in delay-200">
              通信工程 · 本科在读 · 哈尔滨工业大学(深圳)
            </h2>
            <div className="prose max-w-none text-gray-700 leading-relaxed animate-fade-in delay-300">
              <p className="mb-4">
          ...
          <div className="w-48 h-48 rounded-full overflow-hidden hover-scale animate-scale-in delay-200 shadow-lg">
            <img 
              src="/photo.jpg" 
              alt="张昕" 
      ...
      <AnimatedSection>
        <section id="education" className="mb-16 scroll-mt-20">
          <h2 className="text-2xl font-serif font-bold text-gray-900 mb-6 pb-2 border-b-2 border-blue-600 hover:pl-2 transition-all duration-300">
            教育背景
          </h2>
          <HoverCard>
      ...
      <AnimatedSection delay={100}>
        <section id="projects" className="mb-16 scroll-mt-20">
          ...
          <div className="space-y-6">
            <article className="border-l-4 border-blue-600 pl-4 py-4 pr-4 bg-white rounded-r-lg transition-all duration-300 hover:bg-blue-50 hover:-translate-y-1 hover:shadow-lg">
            ...
            <article className="border-l-4 border-gray-400 pl-4 py-4 pr-4 bg-white rounded-r-lg transition-all duration-300 hover:bg-gray-50 hover:-translate-y-1 hover:shadow-lg">
              <div className="flex justify-between items-start mb-2">
                <h3 className="text-base font-semibold text-gray-900">
      ...
      <AnimatedSection delay={100}>
        <section id="skills" className="mb-16 scroll-mt-20">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-gray-50 p-6 rounded-lg hover:bg-blue-50 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
          ...
          <div className="mt-4 bg-gray-50 p-6 rounded-lg hover:bg-blue-50 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
      ...
      <AnimatedSection delay={100}>
        <section id="awards" className="mb-16 scroll-mt-20">
          ...
          <div className="space-y-4">
            <div className="flex justify-between items-start border-b border-gray-200 pb-4 p-4 rounded-lg hover:bg-gray-50 transition-all duration-300 hover:-translate-y-1">
              <div>
            ...
            <div className="flex justify-between items-start p-4 rounded-lg hover:bg-gray-50 transition-all duration-300 hover:-translate-y-1">
              <div>
      ...
      <AnimatedSection delay={100}>
        <section id="contact" className="mb-8 scroll-mt-20">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="p-4 rounded-lg hover:bg-gray-50 transition-all duration-300 hover:-translate-y-1">
          ...
          <div className="mt-6 p-4">
            ...
            <div className="flex gap-4 text-sm">
              <a
                ...
                className="text-blue-600 hover:underline hover:scale-105 inline-block transition-transform"
              >
                GitHub
              </a>
            </div>
